...
export class Chip8Wasm {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        Chip8WasmFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_chip8wasm_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.chip8wasm_new();
        this.__wbg_ptr = ret >>> 0;
        Chip8WasmFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {string} mode
    ...
    reload(mode, rom) {
        ...
        wasm.chip8wasm_reload(this.__wbg_ptr, ptr0, len0, rom);
    }
    /**
     * @param {JSGraphicsCtx} gctx
     * @param {JSInput} ihandle
     */
    tick(gctx, ihandle) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        _assertClass(gctx, JSGraphicsCtx);
        if (gctx.__wbg_ptr === 0) {
            throw new Error('Attempt to use a moved value');
        }
        _assertClass(ihandle, JSInput);
        if (ihandle.__wbg_ptr === 0) {
            throw new Error('Attempt to use a moved value');
        }
        const ret = wasm.chip8wasm_tick(this.__wbg_ptr, gctx.__wbg_ptr, ihandle.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
}
if (Symbol.dispose) Chip8Wasm.prototype[Symbol.dispose] = Chip8Wasm.prototype.free;

export class JSGraphicsCtx {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        JSGraphicsCtxFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_jsgraphicsctx_free(ptr, 0);
    }
    /**
     * @param {number} scale
     * @param {string | null} [color_fg]
     * @param {string | null} [color_bg]
     */
    constructor(scale, color_fg, color_bg) {
        _assertNum(scale);
        var ptr0 = isLikeNone(color_fg) ? 0 : passStringToWasm0(color_fg, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(color_bg) ? 0 : passStringToWasm0(color_bg, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.jsgraphicsctx_new(scale, ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        JSGraphicsCtxFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) JSGraphicsCtx.prototype[Symbol.dispose] = JSGraphicsCtx.prototype.free;

export class JSInput {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        JSInputFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_jsinput_free(ptr, 0);
    }
    /**
     * @param {KeyboardEvent} event
     * @param {boolean} pressed
     */
    keypressEvent(event, pressed) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        _assertBoolean(pressed);
        wasm.jsinput_keypressEvent(this.__wbg_ptr, event, pressed);
    }
    constructor() {
        const ret = wasm.jsinput_new();
        this.__wbg_ptr = ret >>> 0;
        JSInputFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) JSInput.prototype[Symbol.dispose] = JSInput.prototype.free;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_error_290de5487bca6d05: function() { return logError(function (arg0) {
            console.error(...arg0);
        }, arguments); },
        ...
        __wbg_log_3e08aa4d12dba7f3: function() { return logError(function (arg0) {
            console.log(...arg0);
        }, arguments); },
    ...
    return {
        __proto__: null,
        "./chip8_wasm_bg.js": import0,
    };
}


//#endregion
const Chip8WasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_chip8wasm_free(ptr >>> 0, 1));
const JSGraphicsCtxFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_jsgraphicsctx_free(ptr >>> 0, 1));
const JSInputFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_jsinput_free(ptr >>> 0, 1));
